...
This file is taken from GitHub user
[mxstbr's markdown-test-file](https://github.com/mxstbr/markdown-test-file)
repository, and was used to test the output of markdown files through the
printer.
